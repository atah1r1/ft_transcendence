  ...
  return (
    <div className={ cn( styles_box.profile_setting, `${ menu && styles_box.navOpen }` ) }>
      <div className={ styles_s_l.profile_info }>
        ...
        <p className={ styles_s_l.profile_info_login }>{ data?.username ? data.username : user.username }</p>
        <p className={ styles_s_l.profile_info_full_name }>{ `${ data?.last_name ? data.last_name : user.last_name } 
        ${ data?.first_name ? data.first_name : user.first_name }` }</p>
      </div>
