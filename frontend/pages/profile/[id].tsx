...
const FriendProfile = () => {
  ...
  const [{ opAchievments }, { setOpAchievments }] =
  ...
  useEffect(() => {
    axios
      .get(`${process.env.NEXT_PUBLIC_BACKEND_URL}/game/${id}/history`, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.NEXT_PUBLIC_BACKEND_URL}/user/${id}`, {
        withCredentials: true,
      })
      .then((res) => {
        setData(res.data);
                    ...
                    <div className={styles.ach_medal}>
                      <div
                        className={cn(
                          ...
                          `${opAchievments.ach1 && styles.medal}`
                        )}
                      >
                        <div className={styles.ach_goal}>First match</div>
                        <Image
                          className={`${
                            !opAchievments.ach1 && styles_st.non_medal
                          }`}
                          src="/ach1.png"
                          alt="medal_img"
                          width="90%"
                      ...
                      <div
                        className={cn(
                          styles.ach_medal_box,
                          `${opAchievments.ach2 && styles.medal}`
                        )}
                      >
                        <div className={styles.ach_goal}>
                          Reaching 350 points
                        </div>
                        <Image
                          className={`${
                            !opAchievments.ach2 && styles_st.non_medal
                          }`}
                          src="/ach2.png"
                          alt="medal_img"
                          width="90%"
                      ...
                      <div
                        className={cn(
                          styles.ach_medal_box,
                          `${opAchievments.ach3 && styles.medal}`
                        )}
                      >
                        <div className={styles.ach_goal}>
                        ...
                        <Image
                          className={`${
                            !opAchievments.ach3 && styles_st.non_medal
                          }`}
                          src="/ach3.png"
                          alt="medal_img"
                          width="90%"
                      ...
                      <div
                        className={cn(
                          styles.ach_medal_box,
                          `${opAchievments.ach4 && styles.medal}`
                        )}
                      >
                        <div className={styles.ach_goal}>1000 Points</div>
                        <Image
                          className={`${
                            !opAchievments.ach4 && styles_st.non_medal
                          }`}
                          src="/ach4.png"
                          alt="medal_img"
                          width="90%"
